...
<head>
    ...
    <meta name="viewport" content="width=device-width,  evice-width, initial-scale=1.0">
    ...
    <div id="wrapper">
        <form id="form-reg" class ="reg" action="" method="post" >
            ...
            <i class="fa fa-id-card" aria-hidden="true"></i>
                <input type="text" name ="name" class="form-input" placeholder="Họ và tên" id="Tên KH" required>
                
            </div>
            <div class="form-group">
                <i class="far fa-user"></i>
                <input type="text" name ="id" class="form-input" placeholder="Tên đăng nhập" id="Tên đăng nhập" required>
            </div>
            <div class="form-group">
                <i class="fas fa-key"></i>
                <input type="password" name ="pass" class="form-input" placeholder="Mật khẩu" id="Mật khẩu" required>
            ...
            <div class="form-group">
                <i class="fas fa-key"></i>
                <input type="password" name ="passR" class="form-input" placeholder="Nhập lại mật khẩu" id="Mật khẩu2">
            ...
            <div class="form-group">
                ...
                <input type="number" name ="sdt" class="form-input" placeholder="SĐT" id="SĐT" required>
            </div>

            <div class="form-group">
                <i class="fas fa-passport"></i>
                <input type="passport" name ="cccd" class="form-input" placeholder="CCCD" id="CCCD" required>
            </div>
            <div class="form-se">
...
<script>
let boxElement = document.querySelector('.canhbao');
let check = document.querySelector('.fa-exclamation-circle');
let nut= document.getElementsByClassName('nut-dong');
console.log(boxElement.classList);
console.log(check.classList);
if (boxElement.classList.contains('tc') == true){
    check.classList.remove('fas', 'fa-exclamation-circle');
    boxElement.classList.remove('canhbao');
    boxElement.classList.add('thanhcong');
    check.classList.add('fa-sharp','fa-solid', 'fa-circle-check');
    console.log(check.classList);
}
if (boxElement.classList.contains('tc') == false){
