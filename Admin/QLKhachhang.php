...
<Head>
    ...
    <link rel="stylesheet" href="../css/QLKH.css" type="text/css">
...
<header>
    ...
    <a title="" href="Admin.php">Trang chủ</a>  
        ...
        <div class ="animation start-khachhang"></div>
...
<tr>
    ...
    <td><?php echo $row["Tên KH"];?></td>
    <td><?php echo $row["Tên đăng nhập"];?></td>
    <td><?php echo $row["Mật khẩu"];?></td>
    <td><?php echo $row["SĐT"];?></td>
    <td><?php echo $row["Giới tính"];?></td>
    <td><?php echo $row["Email"];?></td>
    <td><?php echo $row["CCCD"];?></td>
    <td><?php echo $row["Điểm tích lũy"];?></td>
    <td >
        <a  href="../edit/suaKH.php?id=<?php echo $row["Mã KH"];?>">
        <i class="fa fa-pencil" aria-hidden="true"></i></a>
       
        <a href="../edit/xoaKH.php?id=<?php echo $row["Mã KH"];?>" onclick="return confirm('Bạn có thực sự muốn xóa?')">
