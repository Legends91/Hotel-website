...
<header>
    ...
    <a title="" href="Admin.php">Trang chủ</a>  
        ...
        <div class ="animation start-nhatki"></div>
...
<div class="maincontent">
    ...
    <a class="button1" href='../edit/themNKDP.php'>
...
<tr>
    ...
    <td><?php echo $row["Tiền cọc"];?></td>
    <td><?php echo $row["Ghi chú"];?></td>
    <td >
        <a  href="../edit/suaNKDP.php?id=<?php echo $row["Mã NKDP"];?>">
        <i class="fa fa-pencil" aria-hidden="true"></i></a>
       
        <a href="../edit/xoaNKDP.php?id=<?php echo $row["Mã NKDP"];?>" onclick="return confirm('Bạn có thực sự muốn xóa?')">
