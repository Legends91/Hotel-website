...
<div class="Font">
  ...
  <a class="button1" href='../edit/themNKDV.php'>
...
<?php
    ...
    $control = new control();
    $result=$control->lay_dsnkdv();
?>
<?php
while ($row=$result->fetch_assoc())
{?>
<tr>
    <td><?php echo $row["Mã NKDV"];?></td>
    <td><?php echo $row["Mã DV"];?></td>
    <td><?php echo $row["Đơn giá DV"];?></td>
    <td >
        <a  href="../edit/suaNKDV.php?id=<?php echo $row["Mã NKDV"];?>">
        <i class="fa fa-pencil" aria-hidden="true"></i></a>
       
        <a href="../edit/xoaNKDV.php?id=<?php echo $row["Mã NKDV"];?>" onclick="return confirm('Bạn có thực sự muốn xóa?')">
