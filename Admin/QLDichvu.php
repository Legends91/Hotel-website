...
<Head>
    ...
    <link rel="stylesheet" href="../css/QLDichvu.css" type="text/css">
...
<div class="maincontent">
    ...
    <a class="button1" href='../edit/themDV.php'>
...
<tr>
    ...
    <td >
        <a  href="../edit/suaDV.php?id=<?php echo $row["Mã DV"];?>">
        <i class="fa fa-pencil" aria-hidden="true"></i></a>
       
        <a href="../edit/xoaDV.php?id=<?php echo $row["Mã DV"];?>" onclick="return confirm('Bạn có thực sự muốn xóa?')">
